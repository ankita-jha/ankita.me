  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <motion.div 
          className='flex justify-center items-center ml-10' // Added margin-left for positioning
          animate={{ x: [0, 20, 0] }}
          transition={{ duration: 2, repeat: Infinity, repeatType: "loop" }}
        >
          <img src={illustrator} alt='Ankita' className='rounded-full w-48 h-48 object-cover' />
        </motion.div>
      </div>
